...
export default function FrenchSettingsPage() {
  ...
  const t = useTranslations('frenchCoach.settings');
    ...
    <div className="space-y-8">
      ...
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">{t('frenchVariant')}</h3>
        ...
        <div className="flex items-center justify-between p-4 bg-amber-50 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-amber-800">{t('variantWarning')}</p>
              <p className="text-xs text-amber-700 mt-0.5">
                {t('variantWarningDesc')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end mt-6">
          ...
          >
            ...
            {updateMutation.isPending ? 'Saving...' : t('saveSettings')}
          </Button>
        </div>
      </Card>
      ...
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">{t('keyDifferences')}</h3>
            <p className="text-sm text-gray-500">{t('keyDifferencesDesc')}</p>
          </div>
        </div>
