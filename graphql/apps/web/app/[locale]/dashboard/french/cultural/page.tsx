...
export default function FrenchCulturalPage() {
  ...
  const t = useTranslations('frenchCoach.cultural');
  ...
  return (
    <div className="space-y-8">
      ...
      {!showHistory ? (
        <>
          <Card padding="md">
            <h3 className="font-semibold text-gray-900 mb-3">{t('getTip')}</h3>
            ...
            <div className="flex gap-3">
              ...
              <Button onClick={() => generateTip()} disabled={loadingTip}>
                {loadingTip ? (
                  ...
                  <><Lightbulb className="w-4 h-4" />{t('getTipButton')}</>
                )}
              </Button>
              {currentTip && (
          ...
          {currentTip ? (
            <Card padding="lg">
              ...
              <div className="space-y-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  <p className="text-sm text-gray-500 mb-1">{t('francais')}</p>
            ...
            <Card padding="lg" className="text-center">
              <div className="py-8">
                ...
                <p className="text-gray-500">{t('generatingTip')}</p>
              </div>
            </Card>
          ) : (
            <EmptyState
        ...
        <div className="space-y-4">
          ...
          {hLoading ? (
            ...
            <EmptyState
              ...
              action={{ label: t('getTipButton'), onClick: () => setShowHistory(false) }}
            />
          ) : (
