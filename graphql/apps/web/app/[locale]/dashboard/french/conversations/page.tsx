...
function FrenchConversationsContent() {
  ...
  const t = useTranslations('frenchCoach.conversations');
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={t('title')}
        description={tCoach('description')}
      >
          ...
          <div className="flex-1 overflow-y-auto space-y-1 rounded-lg border border-gray-100 bg-white p-2">
            {listLoading ? (
              ...
              <div className="text-center py-8 px-4">
                ...
                <p className="text-xs text-gray-500">{tCoach('noConversations')}</p>
              </div>
            ) : (
          ...
          {!showNew && !selectedId ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center max-w-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-1">{t('startConversation')}</h3>
            ...
            <>
              <div className="flex items-center gap-3 px-5 py-3 border-b border-gray-100 shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-400">
                    {showNew ? t('newConversation') : `${messages.length} messages`}
                  </p>
                </div>
                {!showNew && (
                  <Button
              ...
              {selectedConv?.jobDescription && (
                <div className="px-5 py-2.5 bg-indigo-50 border-b border-indigo-100 shrink-0">
                  <p className="text-[10px] font-semibold text-indigo-700 mb-0.5">{tCoach('jobDescription')}</p>
              ...
              <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
                {showNew && messages.length === 0 && !sendMutation.isPending && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-xs text-gray-400 mt-1">{t('startMessage')}</p>
                  </div>
                )}
                          ...
                          <div className="px-1 space-y-1">
                            ...
                            <div id={`eval-${msg.id}`} className="hidden space-y-2">
                              <div className="bg-green-50 border border-green-100 rounded-lg p-2.5">
                                <p className="text-[10px] font-semibold text-green-700 mb-1">{t('improved')}</p>
                              ...
                              {msg.evaluation.corrections?.map((c: GqlFrenchCorrection, i: number) => (
                                <div key={i} className="bg-amber-50 border border-amber-100 rounded-lg p-2.5">
                                  <p className="text-[10px] font-semibold text-amber-700 mb-0.5">{t('correction')}</p>
                                  <p className="text-xs">
                  ...
                  <div className="mb-3 bg-amber-50 rounded-xl p-3 space-y-2">
                    ...
                    {hintData.suggestedResponse && (
                      <div className="bg-white rounded-lg p-2.5 border border-amber-100">
                        <p className="text-[10px] font-medium text-amber-800 mb-0.5">{t('suggestedResponse')}</p>
                ...
                {voiceMode ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between mt-1.5">
                      <p className="text-[10px] text-gray-400">{t('pressEnter')}</p>
                      <div className="flex items-center gap-2">
                        <AutoSpeakToggle
                          enabled={autoSpeak}
