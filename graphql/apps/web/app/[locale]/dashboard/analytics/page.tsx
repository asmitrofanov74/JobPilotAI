...
export default function AnalyticsPage() {
  ...
  const STATS = [
    { label: t('totalApplications'), value: totalApplications, icon: Briefcase, bg: 'bg-blue-50', color: 'text-blue-600' },
    ...
    { label: t('acceptanceRate'), value: `${acceptanceRate}%`, icon: TrendingUp, bg: 'bg-cyan-50', color: 'text-cyan-600' },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card padding="lg">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">{t('applicationFunnel')}</h2>
          {funnelLoading ? (
          ...
          {monthlyLoading ? (
            ...
            <ResponsiveContainer width="100%" height={300}>
              <LineChart data={monthlyData}>
                ...
                <YAxis tick={{ fontSize: 12 }} />
                <Tooltip />
                <Line type="monotone" dataKey="applications" stroke="#3b82f6" strokeWidth={2} name={t('totalApplications')} />
