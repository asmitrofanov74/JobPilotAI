  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        <div className="flex flex-col items-center gap-2">
          ...
          <p className="text-sm font-medium text-gray-700">
            {uploading ? t('uploading') : isDragActive ? t('dropHere') : t('dragDrop')}
          </p>
      ...
      {isLoading ? (
        ...
        <EmptyState icon={FileText} title={t('noResumes')} description={t('noResumesDesc')} />
      ) : (
            ...
            <Card key={resume.id} hover>
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="flex gap-1">
                  {!resume.isPrimary && (
                    <button onClick={() => setPrimaryMutation.mutate(resume.id)} className="p-1.5 text-gray-300 hover:text-amber-500 transition-colors" title={t('setPrimary')}>
