...
function InterviewCoachContent() {
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-3">
          ...
          <PageHeader
            ...
            description={`${activeInterview.questionCount} questions • ${activeInterview.status === 'completed' ? t('Completed') : t('In Progress')}`}
          />
              ...
              {!answeredQIds.includes(activeQuestion.id) ? (
                <div className="space-y-3">
                  {showHint && hintData ? (
                    <div className="bg-amber-50 rounded-xl p-4 space-y-3">
                      ...
                      {hintData.keyPoints && (
                        <div>
                          <p className="text-xs font-medium text-amber-800 mb-1">{t('Key Points')}</p>
                          <p className="text-sm text-amber-700 whitespace-pre-line">{hintData.keyPoints}</p>
                        </div>
                      )}
                      {hintData.exampleAnswer && (
                        <div>
                          <p className="text-xs font-medium text-amber-800 mb-1">{t('Example Answer')}</p>
                  ...
                  <textarea
                    ...
                    placeholder={currentLang === 'french' ? 'Répondez en français...' : 'Type your answer in English...'}
                  ...
                  <div className="flex justify-end">
                    <Button onClick={() => handleEvaluate(activeQuestion.id)} disabled={!answerText.trim() || isEvaluating}>
                      {isEvaluating ? t('Evaluating…') : t('Submit Answer')}
                    </Button>
                  </div>
                </div>
              ) : showResult && ev ? (
                <div className="space-y-4">
                  ...
                  {ev.improvedAnswer && (
                    <div className="bg-emerald-50 rounded-xl p-4">
                      <p className="text-sm font-medium text-emerald-800 mb-1">{t('Improved Answer')}</p>
                ...
                <div className="flex items-center gap-2 text-emerald-600 bg-emerald-50 rounded-xl p-4">
                  ...
                  <Button variant="ghost" size="sm" onClick={() => setShowResult(true)} className="ml-auto">
                    {t('View Result')} <ChevronRight className="w-4 h-4" />
                  </Button>
                </div>
              )}
        ...
        {isCompleted && (
          <Card padding="lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="font-semibold text-gray-900">{t('Overall Results')}</h3>
            </div>
            <div className="grid grid-cols-3 gap-4 mb-4">
              ...
              <div className="text-center">
                ...
                <p className="text-xs text-gray-500 mt-1">{t('Answered')}</p>
              </div>
              <div className="text-center">
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={t('Interview Coach')}
        description={t('Practice interviews in French or English')}
      >
        <div className="flex items-center gap-2">
          <Button
      ...
      <Card padding="lg">
        <h3 className="font-semibold text-gray-900 mb-4">{t('New Practice Session')}</h3>
        <div className="space-y-4">
          <div>
            <p className="text-sm font-medium text-gray-700 mb-2">{t('Select Scenario')}</p>
          ...
          {scenario === 'CUSTOM_JOB' && (
            <div>
              <p className="text-sm font-medium text-gray-700 mb-1">{t('Job Description')}</p>
              <textarea
          ...
          <div className="flex items-center gap-4">
            <div>
              <p className="text-sm font-medium text-gray-700 mb-1">{t('Number of Questions')}</p>
          ...
          >
            {isGenerating ? t('Generating…') : (
              <>
                <Brain className="w-4 h-4" /> {t('Generate Questions')}
              </>
            )}
          </Button>
        </div>
      ...
      <div>
        <h3 className="text-lg font-semibold text-gray-900 mb-4">{t('Past Interviews')}</h3>
        {allInterviews.length === 0 ? (
          <EmptyState
            icon={Brain}
            title={t('No Interviews Yet')}
            description={t('Start your first practice interview')}
          />
        ) : (
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <Badge variant={interview.status === 'completed' ? 'green' : 'blue'}>
                          {interview.status === 'completed' ? t('Completed') : t('In Progress')}
                        </Badge>
