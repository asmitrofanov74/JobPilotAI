...
const ICON_MAP: Record<string, React.ElementType> = {
  ...
  Jobs: Briefcase,
  Resumes: FileText,
  'Cover Letters': FileEdit,
  Interviews: Calendar,
  'Interview Coach': Brain,
  Skills: Sparkles,
  LinkedIn: UserCheck,
  'French Coach': Languages,
  'Job Scraper': Search,
  Analytics: BarChart3,
  Settings: Settings,
};
...
const NAV_KEYS = [
  ...
  { key: 'Cover Letters', href: '/dashboard/cover-letters' },
  { key: 'Interviews', href: '/dashboard/interviews' },
  { key: 'Interview Coach', href: '/dashboard/interview-coach' },
  { key: 'Skills', href: '/dashboard/skills' },
  { key: 'LinkedIn', href: '/dashboard/linkedin' },
  { key: 'French Coach', href: '/dashboard/french' },
  { key: 'Job Scraper', href: '/dashboard/scraper' },
