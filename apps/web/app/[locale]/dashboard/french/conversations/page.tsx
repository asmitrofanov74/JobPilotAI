          ...
          <div className="flex-1 overflow-y-auto space-y-1 rounded-lg border border-gray-100 bg-white p-2">
            {listLoading ? (
              ...
              <div className="text-center py-8 px-4">
                ...
                <p className="text-xs text-gray-500">{t('No conversations yet')}</p>
              </div>
            ) : (
          ...
          {!showNew && !selectedId ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="text-center max-w-sm">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-1">{t('Start a Conversation')}</h3>
                <p className="text-sm text-gray-500 mb-6">
                  {t('Choose a scenario to begin')}
                </p>
            ...
            <>
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm font-semibold text-gray-900">{scenarioMeta.label}</p>
                    <p className="text-xs text-gray-400">
                      {showNew ? t('New Conversation') : `${messages.length} messages`}
                  </p>
                </div>
                {!showNew && (
                  <Button
              ...
              {selectedConv?.jobDescription && (
                <div className="px-5 py-2.5 bg-indigo-50 border-b border-indigo-100 shrink-0">
                  <p className="text-[10px] font-semibold text-indigo-700 mb-0.5">{t('Job Description')}</p>
                  ...
                  <div className="mb-3 bg-amber-50 rounded-xl p-3 space-y-2">
                    ...
                    {hintData.suggestedResponse && (
                      <div className="bg-white rounded-lg p-2.5 border border-amber-100">
                          <p className="text-[10px] font-medium text-amber-800 mb-0.5">{t('Suggested Response')}</p>
                ...
                {voiceMode ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center justify-between mt-1.5">
                      <p className="text-[10px] text-gray-400">{t('Press Enter to send')}</p>
                      <div className="flex items-center gap-2">
                        <AutoSpeakToggle
                          enabled={autoSpeak}
