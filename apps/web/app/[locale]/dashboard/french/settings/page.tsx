...
export default function FrenchSettingsPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={t('French Settings')}
        description={t('Choose your French variant and preferences')}
      />
      ...
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">{t('French Variant')}</h3>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  {isCurrent && <Badge variant="blue">{t('Current')}</Badge>}
                </div>
        ...
        <div className="flex items-center justify-between p-4 bg-amber-50 rounded-xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-amber-800">{t('Variant Warning')}</p>
              <p className="text-xs text-amber-700 mt-0.5">
                {t('Changing your variant will affect future conversations and vocabulary recommendations')}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center justify-end mt-6">
          ...
          >
            ...
            {updateMutation.isPending ? 'Saving...' : t('Save Settings')}
          </Button>
        </div>
      </Card>
      ...
      <Card padding="lg">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            <h3 className="font-semibold text-gray-900">{t('Key Differences')}</h3>
            <p className="text-sm text-gray-500">{t('Common vocabulary and pronunciation differences')}</p>
          </div>
        </div>
