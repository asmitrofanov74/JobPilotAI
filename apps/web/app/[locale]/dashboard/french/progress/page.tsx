...
export default function FrenchProgressPage() {
  ...
  return (
    <div className="space-y-8">
      <PageHeader
        title={t('Progress')}
        description={t('Track your French learning journey')}
      />
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        <Card padding="lg">
          <h3 className="font-semibold text-gray-900 mb-4">{t('Scores Overview')}</h3>
        ...
        <Card padding="lg">
          <h3 className="font-semibold text-gray-900 mb-4">{t('Sessions by Type')}</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        <Card padding="lg">
          <h3 className="font-semibold text-gray-900 mb-4">{t('Scenarios Practiced')}</h3>
        ...
        <Card padding="lg">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-gray-900">{t('Session History')}</h3>
          ...
          {sessions.length === 0 ? (
            <EmptyState
              ...
              action={{ label: t('Go to Overview'), onClick: () => window.location.href = '/dashboard/french' }}
            />
          ) : (
